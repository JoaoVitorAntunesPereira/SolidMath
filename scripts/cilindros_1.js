...
lb_1.textContent = "Segmentos radiais: n = " + n1.toString() + ";";
lb_2.textContent = "Raio: r = " + r1.toString() + ";";
lb_3.textContent = "Altura: h = " + h1.toString() + ";";

var cylinder_geometry_1 = new THREE.CylinderGeometry(r1, r1, h1, n1/* , 0 */); 
var cylinder_edges_1 = new THREE.EdgesGeometry(cylinder_geometry_1); 
//const cylinder_lines_1 = new THREE.Mesh(cylinder_geometry_1, new THREE.MeshBasicMaterial({color: 0xffffff, wireframe: true}));
var cylinder_lines_1 = new THREE.LineSegments(cylinder_edges_1, new THREE.LineBasicMaterial( { color: 0xffffff } ) ); 

const axesHelper = new THREE.AxesHelper( 5 );
cylinder_lines_1.add(axesHelper);
...
function animate() {
    ...
    //cylinder_lines_1.rotation.z = 0.8;
    //cylinder_lines_1.rotation.x = -Math.PI / 5;
    //cylinder_lines_1.rotation.y -= 0.005;

    //cylinder_lines_1.rotation.x += -0.005;
    ...
    //console.log(cylinder_lines_1.rotation.x);

    //cylinder_lines_1.position.applyEuler(new THREE.Euler(cylinder_lines_1.rotation.x, cylinder_lines_1.rotation.y + rotateVelocity_1, cylinder_lines_1.rotation.z), "XYZ");

    //cylinder_lines_1.geometry.dispose();
    //cylinder_lines_1.geometry = new THREE.CylinderGeometry(r1, r1, h1, n1);

    cylinder_geometry_1 = new THREE.CylinderGeometry(r1, r1, h1, n1/* , 0 */); 
